...
@exp_factory.register_config_factory('wmt_transformer_en_tr/base')
def wmt_transformer_large() -> cfg.ExperimentConfig:
  """WMT Transformer Large.
  ...
  token_batch_size = 24576
  encdecoder = translation.EncDecoder(
      num_attention_heads=8, intermediate_size=hidden_size * 4)
  config = cfg.ExperimentConfig(
      runtime=cfg.RuntimeConfig(enable_xla=True),
      task=translation.TranslationConfig(
          model=translation.ModelConfig(
...
@exp_factory.register_config_factory('transformer_en_tr_blended/base')
def wmt_transformer_large() -> cfg.ExperimentConfig:
  """WMT Transformer Large.
...
@exp_factory.register_config_factory('transformer_tr_en_blended/base')
def wmt_transformer_large() -> cfg.ExperimentConfig:
  """WMT Transformer Large.
